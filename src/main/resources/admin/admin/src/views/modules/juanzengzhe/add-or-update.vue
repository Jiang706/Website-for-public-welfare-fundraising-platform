	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="捐赠电话" prop="juanzengdianhua" >
					<el-input v-model="ruleForm.juanzengdianhua" placeholder="捐赠电话" clearable  :readonly="ro.juanzengdianhua"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="捐赠电话" prop="juanzengdianhua" >
					<el-input v-model="ruleForm.juanzengdianhua" placeholder="捐赠电话" readonly></el-input>
				</el-form-item>
		...
		data() {
			...
			return {
				...
				rules: {
					...
					juanzengdianhua: [
						{ required: true, message: '捐赠电话不能为空', trigger: 'blur' },
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='juanzengdianhua'){
							this.ruleForm.juanzengdianhua = obj[o];
							this.ro.juanzengdianhua = true;
							continue;
						}
						if(o=='xingbie'){
