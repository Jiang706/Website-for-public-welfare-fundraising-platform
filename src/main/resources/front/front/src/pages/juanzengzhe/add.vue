		...
		<el-form
			...
			<el-form-item class="add-item" label="捐赠账号" prop="juanzengzhanghao">
				<el-input v-model="ruleForm.juanzengzhanghao" 
					placeholder="捐赠账号" clearable :disabled=" false  ||ro.juanzengzhanghao"></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item" label="捐赠姓名" prop="xingming">
				<el-input v-model="ruleForm.xingming" 
					placeholder="捐赠姓名" clearable :disabled=" false  ||ro.xingming"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="捐赠电话" prop="juanzengdianhua">
				<el-input v-model="ruleForm.juanzengdianhua" 
					placeholder="捐赠电话" clearable :disabled=" false  ||ro.juanzengdianhua"></el-input>
			</el-form-item>
