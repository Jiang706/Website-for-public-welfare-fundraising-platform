		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						<div class="lable">捐赠金额</div>
						<div class="text "  >{{detail.yijuanjine}}</div>
					</div>
					<div class="item">
						<div class="lable">捐赠详情</div>
						<div class="text "  >{{detail.juanzengxiangqing}}</div>
					</div>
					<div class="item">
					...
					<div class="item">
						<div class="lable">捐赠账号</div>
						<div class="text "  >{{detail.juanzengzhanghao}}</div>
					</div>
					<div class="item">
						<div class="lable">捐赠姓名</div>
